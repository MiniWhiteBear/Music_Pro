...
namespace FairyGUI
{
    ...
    public class ShaderConfig
    {
        ...
        public static string blurName = "blur";
        ...
        public static byte strokeColorAlpha = 255;
        ...
        public static string blurShader = "FairyGUI/BlurFilter";
        ...
        public static void SetShaderWithName(DisplayObject display, string name)
        {
            if (name.Equals(blurName))
                display.shader = blurShader;
            else if (name.Equals(imageName))
                display.shader = imageShader;
            else if (name.Equals(fontName))
                display.shader = bmFontShader;
            else if (name.Equals(textName))
                display.shader = textShader;
        }
    }
}
