...
#pragma warning restore 0649
        ...
        private static TwoLoopingMusic _audioTool;
        public static TwoLoopingMusic audioTool
        {
            get
            {
                if (_audioTool != null)
                ...
                _audioTool = Main.Instance.gameObject.GetComponent<TwoLoopingMusic>();
                return _audioTool;
            }
        }
        ...
        public static VideoPlayer videoPlayer
        {
            get
            {
                ...
                _videoPlayer = Main.Instance.videoPlayer;
                return _videoPlayer;
            }
        }
        ...
        public static AudioMixer audioMixer
        {
            get
            {
                ...
                _audioMixer = Main.Instance.audioMixer;
                return _audioMixer;
            }
        }
